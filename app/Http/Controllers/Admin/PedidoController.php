...
{
    $pedidos = Pedido::with(['usuario', 'venta', 'envio']);
    ...
    // FILTROS AVANZADOS
    // ============================
    $pedidos->when($request->pedido_id, fn($q) =>
