...
return new class extends Migration
{
    public function up()
    {
        Schema::create('tbl_producto_atributos', function (Blueprint $table) {
            ...
            $table->foreignId('id_atributo_valor')->constrained('tbl_atributo_valores', 'id_atributo_valor')->onDelete('cascade');
            $table->decimal('dPrecio_extra', 10, 2)->default(0);
            $table->timestamps();
            
            $table->unique(['id_producto', 'id_atributo', 'id_atributo_valor']);
        });
    }
