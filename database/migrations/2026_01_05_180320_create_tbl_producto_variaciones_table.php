...
return new class extends Migration
{
    public function up()
    {
        Schema::create('tbl_producto_variaciones', function (Blueprint $table) {
            ...
            $table->foreignId('id_producto')->constrained('tbl_productos', 'id_producto');
            $table->string('vSKU', 50)->unique();
            $table->string('vCodigo_barras', 20)->nullable();
            ...
            $table->decimal('dAncho', 8, 2)->nullable();
            $table->decimal('dAlto', 8, 2)->nullable();
            $table->decimal('dProfundidad', 8, 2)->nullable();
