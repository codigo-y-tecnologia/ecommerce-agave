                    ...
                    <form action="{{ route('reembolsos.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control @error('id_venta') is-invalid @enderror" 
                                   id="id_venta" name="id_venta" value="{{ old('id_venta') }}" 
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('dMonto') is-invalid @enderror" 
                                   id="dMonto" name="dMonto" value="{{ old('dMonto') }}" 
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('vMotivo') is-invalid @enderror" 
                                      ...
                                      placeholder="Ingrese el motivo del reembolso" required>{{ old('vMotivo') }}</textarea>
                            @error('vMotivo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('eMetodo_pago') is-invalid @enderror" 
                                ...
                                <option value="paypal" {{ old('eMetodo_pago') == 'paypal' ? 'selected' : '' }}>PayPal</option>
                                <option value="transferencia" {{ old('eMetodo_pago') == 'transferencia' ? 'selected' : '' }}>Transferencia</option>
                                <option value="efectivo" {{ old('eMetodo_pago') == 'efectivo' ? 'selected' : '' }}>Efectivo</option>
                                <option value="otro" {{ old('eMetodo_pago') == 'otro' ? 'selected' : '' }}>Otro</option>
                            </select>
                            @error('eMetodo_pago')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control @error('eEstado') is-invalid @enderror" 
                                ...
                                <option value="pendiente" {{ old('eEstado') == 'pendiente' ? 'selected' : '' }}>Pendiente</option>
                                <option value="procesado" {{ old('eEstado') == 'procesado' ? 'selected' : '' }}>Procesado</option>
                                <option value="fallido" {{ old('eEstado') == 'fallido' ? 'selected' : '' }}>Fallido</option>
                            </select>
                            @error('eEstado')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Guardar Reembolso
                            </button>
                        </div>
                    </form>
                </div>
