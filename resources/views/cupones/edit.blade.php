                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('cupones.update', $cupon->id_cupon) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Monto mínimo para que el cupon pueda ser aplicado<span class="text-muted"></span></label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Usos por usuario <span class="text-muted"></span></label>
                                <div class="input-group">
